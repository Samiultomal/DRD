...
import { createPost, getCategoryDetails } from '../../../api/PostApi';
...
function CreatePost() {
    ...
    const breadcrumbsItems = [
        ...
        { label: `Region: ${regionName || 'Loading...'}`, path: `/region/${regionName}` },
        { label: `Category: ${categoryName || 'Loading...'}`, path: `/categories/${categoryId}/posts/add` },
    ];
